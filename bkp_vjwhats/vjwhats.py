...
class WhatsApp:
    ...
    def get_images_sent(self):
        ...
        try:
            ...
            # Acessa a aba de Mídia, links e docs
            dadosButton = self.wait.until(
                EC.presence_of_element_located(
            ...
            # Aguarda o carregamento da aba e verifica se a aba está visível
            self.wait.until(
                EC.presence_of_element_located((By.XPATH, "//div[text()='Neste mês']"))
            )

            # Presiona na primeira imagem
            # Aguarda o carregamento da imagem e verifica se a imagem está visível
                ...
                try:
                    ...
                    try:
                        ...
                        downloadButton = self.wait.until(
                            EC.presence_of_element_located(
                                (By.XPATH, f'//span[@data-icon="download"]')
                            )
                        )
                    ...
                    print(f"Erro na posição {i}:", str(e))
                    break
